...
# (угол пройденный 'A' 54,7356 (60 градусов в углах вероятности) поделится на 2 (количество связей), инвертируется и добавится к положению 'B' и 'C'. Вероятность 1 для 'B' и 'C' = 0)
