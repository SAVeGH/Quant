...
# - если 'A' измерится в 1 то вероятность 0 для B станет 1/3 (1/6 + (1/2)/3.0)
...
# т.е. вектор А совершит 1 полный оборот и еще 1/4 оборота (полный оборот в вероятностях - 2.0)
